...
<meta name="description"
    content="Piskel, free online sprite editor. A simple web-based tool for Spriting and Pixel art. Create pixel art, game sprites and animated GIFs. Free and open-source.">
...
<script defer data-domain="piskelapp.com" src="https://plausible.piskelapp.com/js/script.js"></script>
    <!doctype html>

<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-9208505411762177"
...
<link rel="stylesheet" type="text/css" href="/css/ezoic.73242e78.css">
    

    

    <link rel="shortcut icon" type="image/png" href="/assets/favicon.png">
    <link rel="stylesheet" type="text/css" href="/css/main.aad3d6f1.css">
    <link rel="stylesheet" type="text/css" href="/css/editor.dcbea301.css">
</head>
    ...
    <div class="content-container">
        <div class="editor-sidebar">
            ...
            <div class="sidebar-bottom-container">
                <a class="link" target="_blank" href="/faq#faq-why-ad">Why this ad</a>
                <a class="link" target="_blank" href="/faq#faq-report-ad">Report ad</a>
                <a class="link" target="_blank" href="/privacy">Privacy Policy</a>
            </div>
        ...
        <div class="main-content">
            <div class="editor-header-wrap">
                <div class="navigation ">
                    <span class="piskel-name">New Piskel</span>
                    <a class="link anchor-left  piskel-logo" href="/">
                        <img src="/assets/piskel_logo_transparent_small_compact.png">
                    </a>
                    <div class="nav-buttons nav-buttons-default">
                        <a class="piskel-button create-piskel-button" href="/p/create/sprite" target="_blank">
                            Create<span class="editor-nav-longdesc">
                                Sprite</span>
                        </a>
                    </div>
                    ...
                    <div class="nav-popup" id="tiny-menu-popup">
                        <ul>
                            <li>
                                <a class="user-menu-popup-link user-menu-sprite" href="/p/create/sprite">
                                    Create Sprite
                                </a>
                            </li>
                        </ul>
            ...
            <script type="module">
                // Try to load a generic sprite from a spriteKey in the URL as a query parameter.
                const params = new URLSearchParams(window.location.search);
                const spriteKey = params.get("spriteKey"); // e.g. "github-octopuss" from ?spriteKey=github-octopuss
                if (spriteKey) {
                    try {
                        const response = await fetch(`/assets/sprites/${spriteKey}/${spriteKey}.piskel`);
                        if (!response.ok) {
                            throw new Error(`HTTP error! status: ${response.status}`);
                        }

                        window._externalPiskel = await response.json();

                        // Remove the query parameter from the URL:
                        const url = new URL(window.location.href);
                        url.searchParams.delete('spriteKey');
                        window.history.replaceState({}, document.title, url.toString());

                        function onExternalPiskelLoaded() {
                            window.$.publish('EXTERNAL_PISKEL_READY');
                        }
                        if (window.$ && window.$.publish) {
                            onExternalPiskelLoaded();
                        } else {
                            if (!window.piskelReadyCallbacks) {
                                window.piskelReadyCallbacks = [];
                            }
                            window.piskelReadyCallbacks.push(onExternalPiskelLoaded);
                        }
                    } catch (err) {
                        console.error(`Failed to load sprite for spriteKey <${spriteKey}>:`, err);
                    }
                }
            </script>
...
/**
 * See @Gruntfile.js => after build, -2025-08-24-06-05 is replaced by the build version
 */
var version = '-2025-08-24-06-05';
